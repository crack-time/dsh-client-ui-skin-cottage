    ...
    return (_jsxs("div", { className: "skin-archive", onClick: (e) => e.stopPropagation(), onKeyDown: (e) => e.stopPropagation(), children: [error && _jsx("div", { className: "skin-archive-error", children: error }), _jsxs("div", { className: "skin-archive-list", children: [total === 0 && _jsx("div", { className: "skin-archive-empty", children: "\u6682\u65E0\u5F52\u6863\u4F1A\u8BDD" }), flat !== null &&
                        ...
                        data.groups.map((group) => {
                            ...
                            return (_jsxs("div", { className: "skin-archive-group", children: [_jsxs("div", { className: "skin-archive-group-title", role: "treeitem", "aria-expanded": isExpanded, onClick: () => {
                                        ...
                                        }, children: [_jsx("span", { className: 'skin-archive-folder' + (isExpanded ? ' open' : ''), children: isExpanded ? _jsx(IconFolderOpen, {}) : _jsx(IconFolderClose, {}) }), _jsx("span", { className: "skin-archive-chevron", children: _jsx("span", { className: 'skin-archive-arrow' + (isExpanded ? ' open' : ''), children: _jsx(IconTriangle, {}) }) }), _jsx("span", { className: "skin-archive-project", children: _jsx("span", { className: "skin-archive-title", children: group.title }) })] }), isExpanded &&
                        ...
                        data.ungrouped.length > 0 && (_jsxs("div", { className: "skin-archive-group", children: [_jsxs("div", { className: "skin-archive-group-title", role: "treeitem", "aria-expanded": true, children: [_jsx("span", { className: "skin-archive-folder open", children: _jsx(IconFolderOpen, {}) }), _jsx("span", { className: "skin-archive-chevron", children: _jsx("span", { className: "skin-archive-arrow open", children: _jsx(IconTriangle, {}) }) }), _jsx("span", { className: "skin-archive-project", children: _jsx("span", { className: "skin-archive-title", children: "\u672A\u5206\u7EC4" }) })] }), sortSessions(data.ungrouped).map((item) => (_jsx(SessionRow, { item: item, busy: busy, menuOpen: menu?.item.sessionId === item.sessionId, onMenuOpen: (e) => openMenu(e, item), onOpen: onOpenSession ?? (() => undefined) }, item.sessionId)))] }))] }), menu && (_jsx(ContextMenu, { x: menu.x, y: menu.y, items: [
                    { id: 'rename', label: '重命名' },
