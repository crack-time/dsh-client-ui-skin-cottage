...
export function ArchiveView({ onClose, onOpenSession, }) {
    ...
    return (_jsxs("div", { className: "cottage-archive", onClick: (e) => e.stopPropagation(), onKeyDown: (e) => e.stopPropagation(), children: [error && _jsx("div", { className: "cottage-archive-error", children: error }), _jsxs("div", { className: "cottage-archive-list", children: [total === 0 && _jsx("div", { className: "cottage-archive-empty", children: "\u6682\u65E0\u5F52\u6863\u4F1A\u8BDD" }), flat !== null &&
                    ...
                    { id: 'delete', label: '删除会话', danger: true },
                        ...
                        } }), renameError !== null && (_jsx("div", { className: "cottage-rename-error", role: "alert", children: renameError }))] }), _jsxs(Modal, { open: deleteTarget !== null, onClose: closeDelete, closeLabel: "\u5173\u95ED", title: "\u5220\u9664\u4F1A\u8BDD", description: deleteTarget !== null
                    ? `将删除「${deleteTarget.title}」，会话日志将被移除，此操作不可恢复。`
                    : undefined, footer: _jsxs(_Fragment, { children: [_jsx(Button, { variant: "outline", disabled: deleting, onClick: closeDelete, children: "\u53D6\u6D88" }), _jsx(Button, { variant: "outline", className: "cottage-delete-action", disabled: deleting, onClick: confirmDelete, children: "\u5220\u9664\u4F1A\u8BDD" })] }), children: [deleting && (_jsx("div", { className: "cottage-delete-status", role: "status", children: "\u6B63\u5728\u5220\u9664\u4F1A\u8BDD\u2026" })), deleteError !== null && (_jsx("div", { className: "cottage-rename-error", role: "alert", children: deleteError }))] })] }));
}
