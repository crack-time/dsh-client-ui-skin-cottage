		...
		children: [
				...
				children: [
						...
						return (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("span", {
										className: "cottage-archive-project",
										children: (0, react_jsx_runtime.jsx)("span", {
											className: "cottage-archive-title",
					...
					flat === null && data.ungrouped.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsx)("span", {
									className: "cottage-archive-folder open",
			...
			(0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: [(0, react_jsx_runtime.jsx)("input", {
					...
					className: "cottage-rename-error",
					role: "alert",
			...
			(0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: [deleting && (0, react_jsx_runtime.jsx)("div", {
					className: "cottage-delete-status",
					role: "status",
					children: "正在删除会话…"
...
async function listLevel(sessionId, rel, query, signal) {
	...
	const res = await fetch("/plugins/@crack/dsh-web-ui-skin/api/mention/files?" + params.toString(), { signal });
	if (!res.ok) return {
		cwd: null,
		dir: rel,
		entries: [],
...
* disturbed.
*/
const mentionTokens = /* @__PURE__ */ new Map();
...
function createFileMentionSource() {
	return {
		trigger: "@",
		name: "文件",
		order: 0,
		async candidates(session, { query, signal }) {
			...
			if (rel) {
				...
				return listing.entries.filter((e) => e.name.toLowerCase().startsWith(needle)).map(makeCandidate);
			}
...
*/
function registerFileMention(ctx) {
...
* like a normal edit.
*/
function registerMentionDelete(ctx) {
	const onKeyDown = (e) => {
		...
		const shell = conversation.input?.shell(current);
		...
		children: [(0, react_jsx_runtime.jsxs)("button", {
			...
			children: [
				(0, react_jsx_runtime.jsxs)("span", {
					className: "cottage-settings-headText",
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: "cottage-settings-name",
						children: title
					}), (0, react_jsx_runtime.jsx)("span", {
						className: "cottage-settings-description",
						children: t("description")
					})]
				}),
				dirty ? (0, react_jsx_runtime.jsx)("span", {
					className: "cottage-settings-pending",
					children: t("unsaved")
				}) : null,
				(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: cn("cottage-settings-chevron", open && "cottage-settings-chevron-open") })
			]
		}), open ? (0, react_jsx_runtime.jsxs)("div", {
			className: "cottage-settings-body",
			children: [(0, react_jsx_runtime.jsxs)("label", {
				className: "cottage-settings-row",
				children: [
					(0, react_jsx_runtime.jsx)("span", {
						className: "cottage-settings-label",
					...
					(0, react_jsx_runtime.jsxs)("span", {
						className: "cottage-settings-controls",
						children: [canPickLocally ? (0, react_jsx_runtime.jsx)("button", {
							...
							className: "cottage-settings-hint",
				...
				className: "cottage-settings-footer",
				children: [
					failed ? (0, react_jsx_runtime.jsx)("p", {
						className: "cottage-settings-failed",
						role: "status",
...
*/
function installCottageSettingsCard(ctx, store) {
	const dict = "cottage-skin";
	try {
		ctx.locale?.register(dict, COTTAGE_CARD_LOCALE);
	} catch {}
	try {
