	...
	return (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [(0, react_jsx_runtime.jsxs)("div", {
			...
			children: [(0, react_jsx_runtime.jsx)("button", {
				...
				onClick: () => void onAct("unarchive", item),
				children: "恢复"
				...
				disabled: busy === item.sessionId,
				onClick: () => {
					if (window.confirm(`删除会话「${item.title}」？\n会话日志将被移除，此操作不可恢复。`)) onAct("delete-session", item);
				},
				children: "删除"
			})]
		})]
...
function ArchiveView({ onClose }) {
	...
	const sortSessions = (sessions) => order === "updated" ? [...sessions].sort((a, b) => (b.createdAt ?? "").localeCompare(a.createdAt ?? "")) : sessions;
		...
		children: [
			...
			(0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					data.groups.map((group) => (0, react_jsx_runtime.jsxs)("div", {
						className: "cottage-archive-group",
						children: [(0, react_jsx_runtime.jsx)("div", {
							className: "cottage-archive-group-title",
							children: group.title
						}), sortSessions(group.sessions).map((item) => (0, react_jsx_runtime.jsx)(SessionRow, {
							item,
							busy,
							onAct: act
						}, item.sessionId))]
					}, group.workspaceId)),
					data.ungrouped.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: "cottage-archive-group",
						children: [(0, react_jsx_runtime.jsx)("div", {
							className: "cottage-archive-group-title",
							children: "未分组"
